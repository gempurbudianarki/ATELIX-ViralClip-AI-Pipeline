...
print("=" * 60)
print("\nSummary:")
print("  Config    [OK]   Whisper: large-v3")
print("  Database  [OK]   SQLite (tables created)")
print("  Models    [OK]   Video, Transcription, Clip")
print("  Schemas   [OK]   Pydantic validation")
print("  Subtitles [OK]   Word-level + keyword highlight")
print("  MCP/LLM   [OK]   Analysis prompt builder")
print("  Clips     [OK]   Validation + dedup logic")
print("  Audio     [OK]   Mood detection fallback")
print("  FFmpeg    [OK]   Filter generation")
